...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    const theProduct = multiply(multiply(multArr[0], multArr[1])[0], multArr[2])[0];
    return [theProduct, `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${theProduct}.`];
}
